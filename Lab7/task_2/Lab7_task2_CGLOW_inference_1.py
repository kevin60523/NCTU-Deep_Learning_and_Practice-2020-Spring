...
class CelebADataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return img, np.array(self.label_list[index])
...
for i in range(64):
    images_concat = torchvision.utils.make_grid(images[i], nrow=int(64 ** 0.5), padding=2, pad_value=255)
    torchvision.utils.save_image(images_concat, './output/conditional_'+ str(i) + '.png')